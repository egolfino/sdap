...
items={ 'SUBJECT_ID', 'SUBJECT_GENDER', 'SUBJECT_DOB', 'SUBJECT_GROUP', ...
        ...
        'MOUTH_MIC_DIST', 'SPL_TARGET', 'SPL_RANGE', 'CLOSED_LOOP_GAIN', ...
        ...
        'MASK_NOISE_LV', ...
        'SMN_KERNEL_0', 'SMN_KERNEL_1', ...
        'SMN_ON_RAMP', 'SMN_OFF_RAMP', ...
        'SMN_GAIN'};
...
%     end
    ...
    elseif isequal(item, 'PITCH_SHIFT_DOWN_PCF') || isequal(item, 'PITCH_SHIFT_UP_PCF') || isequal(item, 'PITCH_SHIFT_NONE_PCF')
        ...
        config.(item) = str;
    elseif isequal(item,'SHIFT_RATIO') || isequal(item,'MOUTH_MIC_DIST') || isequal(item, 'CLOSED_LOOP_GAIN') || ...
            ...
            isequal(item, 'SMN_KERNEL_0') || isequal(item, 'SMN_KERNEL_1') || ...
            isequal(item, 'SMN_ON_RAMP') || isequal(item, 'SMN_OFF_RAMP') || ...
            isequal(item, 'SMN_GAIN')
        str=strtrim(str);

function msg = getTriMsgStr(thisphase)
if isnumeric(thisphase)
    msg={sprintf('We are about to start run #%d.', thisphase),...
         '',...
         'As a reminder, the task is to read aloud the sentence', ...
         'displayed on the screen. Please always try to maintain', ...
         'eye fixation on the central crosshair and keep your head', ...
